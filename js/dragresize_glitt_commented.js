...
function DragResizeGlitt(myName, config)
{
 var props = {
...
DragResizeGlitt.prototype.apply = function(node)
{
...
DragResizeGlitt.prototype.select = function(newElement) 
{
...
DragResizeGlitt.prototype.perop = function(w,h)
{
this.elmW = w;
this.elmH = h;
};
DragResizeGlitt.prototype.deselect = function(delHandles) { with (this)
{
...
DragResizeGlitt.prototype.mouseDown = function(e) { with (this)
{
...
/*if(parent.action=='dell')
{
	if(elm)
	{
		parent.deleteGlitter(elm.id);
	}
}

if(parent.action=='rotate_left')
{
parent.rotateGlitter(elm.id,'rotate_left');
}

if(parent.action=='rotate_right')
{
parent.rotateGlitter(elm.id,'rotate_right');
}
//parent.Text(elm.id);
*/
//if(parent.action!='rotate_left' && parent.action!='rotate_right')
//{
...
DragResizeGlitt.prototype.mouseMove = function(e) { with (this)
{
 ...
 with (element.style)
 {
  ...
  top =    elmY + 'px';
  height = elmH + 'px';
  document.getElementById(element.id+'_1').width=parseInt(width);
  document.getElementById(element.id+'_1').height=parseInt(height);
...
DragResizeGlitt.prototype.mouseUp = function(e) { with (this)
{
...
DragResizeGlitt.prototype.resizeHandleSet = function(elm, show) { with (this)
{
...
DragResizeGlitt.prototype.resizeHandleDrag = function(diffX, diffY) { with (this)
{
